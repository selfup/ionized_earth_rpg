pub const MAIN_CAMERA_SCALE: f32 = 0.2;

pub const NORMAL_VELOCITY: f64 = 25.0;
pub const RUNNING_VELOCITY: f64 = 50.0;
...
pub const BUILDING_BLOCK_001: &str = "building-block-001.png";
